...
import './hotel.css'
import { faCircleLeft, faCircleRight, faCircleXmark, faL, faLocationDot } from '@fortawesome/free-solid-svg-icons'
      ...
      <div className="hotelContainer">
        {open && <div className="slider">
          ...
          <div className="sliderWrapper">
            <img src= {hotelPhotos[sliderNumber].src} alt="" className="sliderImg" />
          </div>
